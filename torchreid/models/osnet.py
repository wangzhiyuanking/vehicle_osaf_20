...
class ConvLayer(nn.Module):
    ...
    #  ConvLayer( 3, channels[0],              kernel_size=7, stride=2, padding=3, IN=IN)
...
class OSNet(nn.Module):
    ...
    def __init__(self, num_classes, blocks, layers, channels, feature_dim=512, loss='softmax', IN=False, **kwargs):
        ...
        self.global_avgpool = nn.AdaptiveAvgPool2d(1)
        self.fc = self._construct_fc_layer(feature_dim, channels[3], dropout_p=0.2)
    ...
    def _construct_fc_layer(self, fc_dims, input_dim, dropout_p=0.2):
