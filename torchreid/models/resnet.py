...
class ResNet(nn.Module):
    ...
    def __init__(self,num_classes,loss,block,layers,zero_init_residual=False,groups=1,width_per_group=64,replace_stride_with_dilation=None,norm_layer=None,
                 last_stride=2,fc_dims=None,dropout_p=None,**kwargs):
        super(ResNet, self).__init__()
        # 如果没有norm层，就使用batchNorm
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        ...
        self.inplanes = 64
        self.dilation = 1               #空洞卷积，卷积时隔了一个，使用空洞卷积代替卷积时的stride
